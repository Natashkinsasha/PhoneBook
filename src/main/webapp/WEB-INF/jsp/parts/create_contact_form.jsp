...
<form novalidate id="create_contact_form" method="post" action="/createcontact" enctype="multipart/form-data" acceptcharset="UTF-8">
    <div class="container">
        <div class="row">
            <div class="col-xs-4">
        ...
        <div class="btn-group" role="group" aria-label="...">
            ...
            <button type="button" class="btn btn-warning" onclick="location.href='/deletecontact?id=<%=contactDTO.getId()%>'">Delete
            </button>
        </div>
    </div>
