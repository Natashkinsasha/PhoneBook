    ...
    <div class="row">
        <table class="table">
            ...
            <tr>
                ...
                <th>Comment</th>
                <th>
                    <button type="button" class="btn" data-toggle="modal" onclick="location.href='#modal'"
                            aria-haspopup="true"
            ...
            <tr>
                ...
                <td>
                    <a href="/deletetelephone?id=<%=telephoneDTO.getIdString()%>">Delete</a>
                    <a href="#modal_<%=telephoneDTO.getId()%>" data-toggle="modal"
                       data-target="#modal_<%=telephoneDTO.getId()%>">Edit</a>
                </td>
            </tr>
            <%
                }
